...
const url = "https://www.poetic-house.com";
const consumer_key = "ck_04d50c88d3ab64d389c25338ca794a12859400ae";
const consumer_secret = "cs_eb37e60352d516797ff76c0d6e49653b7585721c";
const stripe_key = "pk_test_51KxCYwLPurHK71WaLLIpSmgZXNWeLGCSM7TCX70EddfZqTnZ1NNmljjm6quKIe9eOCebVVM0GwQXaHG7TgoRaPKB00KMrxnI3A";
const oneSignal_id = "43948a3d-da03-4e1a-aaf4-cb38f0d9ca51";
export default {
    /**
    ...
    WooCommerce: {
        url: "skksdj",
        consumerKey:"sjhdjsdh",
        consumerSecret:"sjhdjshd",
    },
    ...
    menu: {
        ...
        listMenu: [
            ...
            },
            {
                ...
                routeName: "CustomPage",
                params: {
                    url: "https://www.poetic-house.com/rose_crown/",
                },
    ...
    ProfileSettings: [
        ...
        },
        {
            ...
            routeName: "CustomPage",
            params: {
                url: "https://www.poetic-house.com/refund_returns/",
            },
        },
        {
            label: "About",
